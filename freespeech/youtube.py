...
# Reference resources:
# - https://github.com/tokland/youtube-upload/blob/master/youtube_upload/auth/__init__.py
...
def initialize_upload(youtube, video_file, title, description, tags, category_id, privacy_status):
    body = {
        "snippet": {
            "title": title,
...
def upload(video_file, meta_file, credentials_file):
    ...
    DISCLAIMER = f"The voice in this video has been automatically generated based on translated transcript of the original video {meta['url']}."
